...
'''alunos = int(input("Digite a quantidade de aluinos para média da turma:"))
soma= 0
for i in range(alunos):
    nota = float(input(f"Digite a nota do aluno {i+i}: "))
    soma += nota
print("A médias de nota dos alunos é:", soma /alunos)'''
